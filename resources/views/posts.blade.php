<x-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-2 mx-auto max-w-screen-xl lg:py-8 lg:px-2">
...
{{-- <article class='py-8 max-w-screen-md border-b border-gray-500'>
            ...
            <div class='text-white text-base'>
                by <a href='/author/{{ $post->author->username }}'
                    class='text-gray-400 text-base hover:underline'>{{ $post->author->name }} </a>
                in <a href='/category/{{ $post->category->slug }}'
                    class='text-gray-400 text-base hover:underline'>{{ $post->category->name }} </a>
